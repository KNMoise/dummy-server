		...
		<div class="header">
			<div class="logo_invoice_wrap">
				...
				<div class="invoice_sec">
					...
					$select = "SELECT job_title FROM incomes WHERE job_id = '$job'";
		...
		<div class="body">
			<div class="main_table">
				...
				<div class="table_body">
					<?php
						...
						$sql = "SELECT DISTINCT  j.job_id, j.job_title, SUM(e.amount) AS total_expenses, j.income, j.job_date FROM incomes j LEFT JOIN expenses e ON j.job_id = e.job_linked WHERE j.job_id = '$job' GROUP BY j.job_id;";
			...
			<div class="paymethod_grandtotal_wrap" style="margin: auto;">
				...
				<div class="grandtotal_sec">
					<?php 
						$query = "SELECT SUM(income) as total_earnings FROM incomes  WHERE job_id = '$job';";
			    	...
			    	<?php 
						$query = "SELECT SUM(amount) as total_expense FROM expenses WHERE job_linked = '$job';";
						$query2 = mysqli_query($conn, $query);
