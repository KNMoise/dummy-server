<?php 
 ...
 ?>
                ...
                <div class="container-fluid" style="margin-top: 0;">
                    <h3 class="text-dark mb-4">FAQs Editing</h3>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="text-primary m-0 fw-bold"> FAQs Editing</h6>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
                                <p class="m-0">Update Information You wish to Change..</p>
                                <?php 
                                    $question_id = mysqli_escape_string($conn, $_GET['question_id']);

                                    $query = "SELECT * FROM faqs WHERE question_id='$question_id';";
                                ...
                                ?>
                                <form method="POST" action="../operations/update_faqs.php?id=<?php echo $question_id; ?>">
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" id="username-5" value="<?php echo $question; ?>" placeholder="Question" name="question">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" id="first_name-3" value="<?php echo $answer; ?>" placeholder="answer" name="answer">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-success btn-icon-split" name="update">
                                          ...
                                          <span class="text-center text-white text">Update Faqs</span>
                                        </button>
